...
class GitHubInfo extends Component<GitHubInfoProps, GitHubInfoState> {
    ...
    constructor(properties: GitHubInfoProps) {
        super(properties);
    ...
    public componentDidUpdate(previousProperties: GitHubInfoProps): void {
